...
class RegressionErrorLayer : public Layer<Dtype> {
 public:
  explicit RegressionErrorLayer(const LayerParameter& param)
  ...
  virtual inline LayerParameter_LayerType type() const {
    return LayerParameter_LayerType_REGRESSION_ERROR;
  }
 ...
 protected:
  ...
  /// @brief Not implemented -- RegressionErrorLayer cannot be used as a loss.
